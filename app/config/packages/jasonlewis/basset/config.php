    ...
    'collections' => array(
        ...
        'admin-js' => function($collection)
        {
            $collection->directory('assets/js', function($collection)
            {
                ...
                $collection->add('wysihtml5/jquery.tablesorter.min.js');
                $collection->add('wysihtml5/jquery.metadata.js');
                $collection->add('wysihtml5/jquery.tablecloth.js');
            })->apply('UriRewriteFilter');
        },
