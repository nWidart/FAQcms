    ...
    <div class="row-fluid">
        <div class="span9">
            <div class="control-group {{ $errors->has('title') ? 'error' : '' }}">
                <input type="text" name="title" id="title" class="span9 questionTitle" value="{{ Input::old('title', $question->getTitleAttribute()) }}" />
        ...
        <div class="span3 well metaData">
            ...
            <div class="btn-group">
                ...
                <button href="#modalDelete" role="button" data-toggle="modal" class="btn btn-danger btn-large">{{ Lang::get('button.delete') }}</button>
                <button type="submit" class="btn btn-success btn-large">{{ Lang::get('button.edit') }}</button>
            </div>
            <!-- ./ form actions -->
